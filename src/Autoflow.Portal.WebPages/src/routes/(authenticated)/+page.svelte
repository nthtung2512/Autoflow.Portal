<script lang="ts">
	...
	import FirstColumn from '$lib/components/FirstColumn.svelte';
	import SecondColumn from '$lib/components/SecondColumn.svelte';
	...
	import {
		...
		joinConversation,
		leaveConversation
	} from '$lib/services/signalrService';
	import { usersStore } from '$lib/stores/userStore';
	import { authStore } from '$lib/stores/authStore';
	import { createUCMapStore } from '$lib/stores/userConversationMap';
	import { createConversationStore } from '$lib/stores/conversationStore';
	import { createMessageStore } from '$lib/stores/messageStore';
